...
migrate((app) => {
  ...
  const collection = new Collection({
    "createRule": "@request.auth.role = 'admin' || @request.auth.role = 'family'",
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_2555148759");
