...
migrate((app) => {
  ...
  const collection = new Collection({
    "createRule": "@request.auth.role = 'family' || @request.auth.role = 'admin'",
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_9391518705");
