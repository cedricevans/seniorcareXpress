...
migrate((app) => {
  ...
  const collection = new Collection({
    "createRule": "@request.auth.role = 'admin' || (@request.auth.role = 'caregiver' && caregiver_id = @request.auth.id)",
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_8037212023");
